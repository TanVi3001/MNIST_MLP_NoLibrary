...
| Layer  | Số neuron | Activation | Mục đích                       |
| ------ | --------: | ---------- | ------------------------------ |
| Input  |       784 | -          | Ảnh MNIST 28 × 28 được flatten |
| Hidden |       128 | ReLU       | Học các đặc trưng của ảnh      |
| Output |        10 | Softmax    | Xác suất của các chữ số 0–9    |
...
| -------------------- | --------------------------------- |
| $X$                  | Dữ liệu đầu vào                   |
| $Y_{\text{one-hot}}$ | Nhãn thực tế dạng One-Hot         |
| $W_1, b_1$           | Trọng số và bias của hidden layer |
| $W_2, b_2$           | Trọng số và bias của output layer |
| $\alpha$             | Learning rate                     |
